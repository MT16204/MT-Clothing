...
const Collection = () => {
  ...
  const sortProducts = (e) => {
    ...
    switch(sortType){
      case 'low-high': setFilterProducts(sortCopy.sort((a,b) => a.price - b.price)); break;

      case 'high-low': setFilterProducts(sortCopy.sort((a,b) => b.price - a.price)); break;
    ...
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className='min-w-60'>
          ...
          <div className={`border border-gray-300 pl-5 py-3 mt-6 ${showFilter ? '' : 'hidden'} sm:block`}>
            ...
            <div className='flex flex-col gap-2 text-sm font-light text-[#4f4e4e]'>
